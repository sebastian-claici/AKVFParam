...
private:
  ...
  bool backtracking_wolfe_conditions_search(const Eigen::MatrixXd& V, const Eigen::MatrixXi& F, Energy* e,
 ...
 public:
  int type = 0;
  double wolfe_c1 = 1e-5;
  double wolfe_c2 = 0.99;
  double search_rho = 0.8;
  double rho = 0.9;
};
