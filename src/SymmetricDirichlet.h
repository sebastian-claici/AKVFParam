...
public:
  ...
  double compute_energy(const Eigen::MatrixXd& V, const Eigen::MatrixXi& F,
   								 Eigen::MatrixXd& uv) {
	  return compute_energy(V,F,(const Eigen::MatrixXd)uv);
  }
  ...
  void compute_grad(const Eigen::MatrixXd& V, const Eigen::MatrixXi& F,
